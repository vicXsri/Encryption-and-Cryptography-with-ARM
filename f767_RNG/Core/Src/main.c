...
//	        "[3] %10lu\r\n"
//	        "\r\n",
//	        key128[0], key128[1], key128[2], key128[3]);
//
//	HAL_UART_Transmit(&huart3, (uint8_t *)buff, strlen(buff), HAL_MAX_DELAY);
//
//	keyGenerator(key192_BlockSize, key192);
...
//	        "[5] %10lu\r\n"
//	        "\r\n",
//	        key192[0], key192[1], key192[2], key192[3], key192[4], key192[5]);
//
//	HAL_UART_Transmit(&huart3, (uint8_t *)buff, strlen(buff), HAL_MAX_DELAY);
//
//	keyGenerator(key256_BlockSize, key256);
...
//	        "[7] %10lu\r\n"
//	        "\r\n",
//	        key256[0], key256[1], key256[2], key256[3],
//	        key256[4], key256[5], key256[6], key256[7]);
//
//	HAL_UART_Transmit(&huart3, (uint8_t *)buff, strlen(buff), HAL_MAX_DELAY);
//
//
